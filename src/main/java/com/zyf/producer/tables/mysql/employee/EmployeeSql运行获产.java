...
import com.zyf.producer.tables.mysql.department.DeptSql消费者;
import com.zyf.producer.tables.mysql.通用Sql获产者;
...
@Slf4j
public class EmployeeSql运行获产 extends 公共Sql运行<MySql的Sql运行上下文, 通用Sql获产者> {

    public static void main(String[] args) throws InterruptedException {
        new EmployeeSql运行获产().执行(args,
                ()->new 通用Sql获产者(Department.instance),
                MySql的Sql运行上下文::new,
                mode -> {
